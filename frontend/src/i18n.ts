...
(function () {
  ...
  const DICT: Record<LangCode, Record<string, string>> = {
    en: {
      ...
      'settings.permGrant': 'Grant background & notifications',
      'settings.permHint': 'Re-open the prompt for notifications and unrestricted background power. Takes effect next time the app starts.',
      ...
      'toast.permReset': 'Whale will ask for permissions next time it starts.',
    ...
    'zh-Hans': {
      ...
      'settings.permGrant': '授予后台运行与通知权限',
      'settings.permHint': '重新弹出通知与后台无限制电源使用的授权提示，下次启动应用时生效。',
      ...
      'toast.permReset': 'Whale 将在下次启动时申请权限。',
    ...
    'zh-Hant': {
      ...
      'settings.permGrant': '授予背景執行與通知權限',
      'settings.permHint': '重新彈出通知與背景無限制電源使用的授權提示，下次啟動應用程式時生效。',
      'ph.server': 'https://whale.example.com（留空 = 本站）',
      ...
      'toast.permReset': 'Whale 將在下次啟動時申請權限。',
